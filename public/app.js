...
async function fetchNews(ticker) {
    try {
        const response = await fetch(`${API_BASE_URL}/api/news?ticker=${ticker}`);
...
async function fetchAnalysis(ticker) {
    try {
        const response = await fetch(`${API_BASE_URL}/api/analyze?ticker=${ticker}`);
...
async function fetchStrategy(ticker) {
    try {
        const response = await fetch(`${API_BASE_URL}/api/strategy?ticker=${ticker}`);
...
async function fetchPriceData(ticker, period = '1M') {
    try {
        const response = await fetch(`${API_BASE_URL}/api/prices?ticker=${ticker}&period=${period}`);
...
async function fetchFundamentals(ticker) {
    try {
        const response = await fetch(`${API_BASE_URL}/api/fundamentals?ticker=${ticker}`);
...
async function fetchStockSuggestions(riskLevel, investmentTerm) {
    try {
        const response = await fetch(`${API_BASE_URL}/api/suggestions?risk=${riskLevel}&term=${investmentTerm}`);
